...
import type { getImageResizeParams } from '../types/index.js';


export class CompressionService {
  async compressImage({ buffer, width, height }: { buffer: Buffer; width?: number; height?: number }) {
  ...
  async getResizeImage({ buffer, width, height, blur, rotate, linear, modulate, border }: getImageResizeParams) {
